...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // ✅ Simplified Animations - Only for elements that need it
    const observerOptions = {
        threshold: 0.1,
        rootMargin: '0px 0px -50px 0px'
    };

    // Only observe elements that actually NEED animation (not service-cards)
    ...
    // ✅ Feature cards are now static - no parallax (removed for stable layout)
