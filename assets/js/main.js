...
window.addEventListener('DOMContentLoaded', () => {
    ...
    /* ======================================
       PREMIUM DESIGN ENHANCEMENTS - JAVASCRIPT
       Phase 2 & 3: Magnetic Cards + Text Reveal
       ====================================== */

    // Phase 2.2: Magnetic Card Hover Effect
    ...
    // Phase 3.1: Split Text Reveal for h2 headings
    ...
    document.querySelectorAll('h2').forEach(h2 => {
        const observer = new IntersectionObserver(
            (entries) => {
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        splitTextForAnimation(entry.target);
